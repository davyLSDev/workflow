...
namespace workflow
{
	public partial class ConfigurationDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget workflow.ConfigurationDialog
			this.Name = "workflow.ConfigurationDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child workflow.ConfigurationDialog.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child workflow.ConfigurationDialog.ActionArea
